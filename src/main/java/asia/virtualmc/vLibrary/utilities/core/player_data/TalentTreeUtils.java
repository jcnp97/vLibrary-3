...
public class TalentTreeUtils {
    ...
    public static Map<String, TalentTree> load(@NotNull Plugin plugin, @NotNull String fileName) {
        ...
        for (String talentID : keys) {
            ...
            if (materialName == null || displayName == null) {
                ConsoleUtils.severe(plugin.getName(), "Invalid configuration for talentID: " + talentID);
                continue;
            }
            ...
            try {
                ...
                ConsoleUtils.severe(plugin.getName(), "Invalid material '" + materialName + "' for talentID: " + talentID);
                continue;
            }

            ItemMeta meta = item.getItemMeta();
            if (meta == null) {
                ConsoleUtils.severe("Could not retrieve item meta for talentID: " + talentID);
                continue;
            }
